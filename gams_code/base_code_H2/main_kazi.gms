...
eff(ren) "eff parameter for each renewable" /
wind 0.5
solar 0.1
/
...
Equation pren_eq; pren_eq(ren,t)$(ord(t) ne card(t)).. P_sor(ren,t) =l= eff(ren)*Pmax_sor(ren);
...
Equation eq_Delta_solar_inq; eq_Delta_solar_inq(ren)$(sameAs("solar",ren)).. Delta_solar =l= Delta_solar_max;
Equation eq_Delta_wind_inq; eq_Delta_wind_inq(ren)$(sameAs("wind",ren)).. Delta_wind =l= Delta_wind_max;

Equation eq_max_term_1; eq_max_term_1.. max_term*(PD_max - PD_min) =g= (PD_th - PD_min);
Equation eq_max_term_2; eq_max_term_2.. max_term*(PD_max - PD_min) =g= (PD - PD_min);


Equation eq_Delta_solar_eq; eq_Delta_solar_eq(ren,t)$(sameAs("solar",ren)).. Delta_solar_max =e= ghi(t)*A_total*(1-max_term);
Equation eq_Delta_wind_eq; eq_Delta_wind_eq(ren,t)$(sameAs("wind",ren)).. Delta_wind_max =e= rho_air*wind_speed(t)*wind_speed(t)*wind_speed(t)*A_total*(1-max_term);
